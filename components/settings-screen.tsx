...
export function SettingsScreen({ isDarkMode, onToggleDarkMode, onSwitchToAdmin, onLogout }: SettingsScreenProps) {
        ...
        <div className="p-4 space-y-4">
          ...
          <div className={`rounded-xl p-4 ${isDarkMode ? "bg-gray-800" : "bg-white"} shadow-sm`}>
            ...
            <div className="space-y-3">
              ...
              <button 
                onClick={onLogout}
                className={`w-full flex items-center gap-3 p-3 rounded-lg text-red-500 transition-colors ${
